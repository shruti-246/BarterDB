    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_given', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='given_in_transactions', to='barterapp.product')),
                ('product_received', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received_in_transactions', to='barterapp.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='barterapp.transaction')),
            ],
        ),
    ]
